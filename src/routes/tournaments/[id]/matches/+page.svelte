<script lang="ts">
	...
	import type { TournamentStatus, Tournament, Match, Standing } from '$lib/types/league.js';
...
<div class="flex flex-col gap-6">
	<div class="flex flex-wrap items-center gap-3">
		<a href="/tournaments/{tournament.id}" class="btn btn-ghost btn-sm">Zurueck zur Tabelle</a>
		...
		<span class="badge badge-outline">Organisator</span>
	</div>
